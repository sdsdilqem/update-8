...
export default function FeaturedBanner({
  ...
  return (
    <Link
      to={link}
      className="relative overflow-hidden rounded-[5px] group hover:shadow-lg transition-all duration-300"
    ...
    >
      ...
      <div className="absolute top-3 left-3 z-20">
        <div
          className={`${color} w-8 h-8 rounded-[5px] shadow-lg backdrop-blur-md flex items-center justify-center`}
        >
